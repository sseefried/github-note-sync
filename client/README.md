...
13. On mobile layouts, markdown files get a compact header toggle next to the `<` button that switches between source editing and rendered GitHub Flavored Markdown preview.
